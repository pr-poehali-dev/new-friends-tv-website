...
const Index = () => {
  ...
  const shows = [
    ...
    { 
      ...
      description: 'Ежегодный международный телевизионный конкурс детской авторской песни. Проходит с 2023 года. Прямая трансляция из VTB Арены', 
      type: 'Музыка',
      category: 'Музыка',
      episodes: [
        { id: 1, title: '3-й Финал конкурса 2025 - Прямой эфир', date: '12 ноября 2025', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 2, title: 'Полуфинал 2025', date: '11 ноября 2025', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 3, title: 'Отборочный тур 2025', date: '10 ноября 2025', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 4, title: '2-й Финал 2024 - Полная версия', date: '12 ноября 2024', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 5, title: '1-й Финал 2023 - Первый конкурс', date: '12 ноября 2023', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
      ],
      hasContest: false
    },
    { 
