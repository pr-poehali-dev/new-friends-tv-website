...
const Index = () => {
  ...
  const shows = [
    ...
    { 
      ...
      description: 'Ежегодный международный телевизионный конкурс детской авторской песни. Прямая трансляция из VTB Арены', 
      type: 'Музыка',
      category: 'Музыка',
      episodes: [
        { id: 1, title: 'Финал конкурса 2025 - Прямой эфир', date: '12 ноября', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 2, title: 'Полуфинал 2025', date: '11 ноября', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 3, title: 'Отборочный тур 2025', date: '10 ноября', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 4, title: 'Финал 2024 - Лучшие моменты', date: '12 ноября 2024', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
        { id: 5, title: 'Финал 2023 - Лучшие моменты', date: '12 ноября 2023', videoUrl: 'https://www.youtube.com/embed/9Auq9mYxFEE' },
      ],
      hasContest: false
    },
    { 
